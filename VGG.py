...
# mymodel=model.fit(x_train,y_train,batch_size=20,epochs=1,validation_data=(x_test,y_test))
# model.summary()
...
# tf.keras.models.save_model(model=model,filepath='./checkpoint/sbdd',save_format='tf')
...
#                                                  save_best_only=True)
#
# history = model.fit(x_train, y_train, batch_size=24, epochs=1, validation_data=(x_test, y_test), validation_freq=1,
